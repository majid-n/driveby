    ...
    return (
      <View style={styles.container}>
        <MapView provider={this.props.provider} style={styles.map} initialRegion={this.state.region}>
          <Overlay bounds={this.state.overlay1.bounds} bearing={30} image={this.state.overlay1.image} />
          <Overlay bounds={this.state.overlay2.bounds} bearing={-30} image={this.state.overlay2.image} />
        </MapView>
      </View>
    );
  }
